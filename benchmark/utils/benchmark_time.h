...
struct BenchmarkTime {
  ...
  double calc2_time_use;
  double destroy_time_use;
  double total_time_use;
  BenchmarkTime() : pre_time_use(0), calc_time_use(0), calc2_time_use(0), destroy_time_use(0), total_time_use(0) {}
  BenchmarkTime(double _pre_time_use, double _calc_time_use, double _calc2_time_use, double _destroy_time_use)
      : pre_time_use(_pre_time_use), calc_time_use(_calc_time_use), calc2_time_use(_calc2_time_use),
  ...
  BenchmarkTime &operator=(const BenchmarkTime &_benchmark_time) {
    ...
    calc2_time_use = _benchmark_time.calc2_time_use;
  ...
  void set_time(double _pre_time_use, double _calc_time_use, double _calc2_time_use, double _destroy_time_use);

  inline void set_time(double _pre_time_use, double _calc_time_use, double _destroy_time_use) {
    set_time(_pre_time_use, _calc_time_use, 0.0, _destroy_time_use);
  }
};
