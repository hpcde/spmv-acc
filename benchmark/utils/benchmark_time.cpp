...
void BenchmarkTime::set_time(double _pre_time_use, double _calc_time_use, double _destroy_time_use) {
...
void BenchmarkTime::update_total_time() { total_time_use = pre_time_use + calc_time_use + destroy_time_use; }
